...
namespace CleanOrders.API.Authentication
{
    public class Authentication : IAuthentication
    {
        private readonly IConfiguration _configuration;
        private readonly ApplicationContext _context;
        public Authentication(IConfiguration configuration, ApplicationContext context)
        {
        ...
        public LoggedInUser GetCurrentUser(HttpContext httpContext)
        {
